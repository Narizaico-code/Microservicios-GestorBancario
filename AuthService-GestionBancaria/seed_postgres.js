...
const seed = async () => {
  try {
    ...
    const usersToSeed = [
      { id: 'user_premium_1', name: 'Usuario Premium 1', email: 'premium1@test.com', role: userRole.Id },
      { id: 'user_vip_2', name: 'Usuario VIP 2', email: 'vip2@test.com', role: userRole.Id },
      { id: 'user_inactive_3', name: 'Usuario Inactivo 3', email: 'inactive3@test.com', role: userRole.Id },
      { id: 'user_new_4', name: 'Nuevo Usuario 4', email: 'new4@test.com', role: userRole.Id },
      { id: 'user_regular_5', name: 'Usuario Regular 5', email: 'regular5@test.com', role: userRole.Id },
      { id: 'user_regular_6', name: 'Usuario Regular 6', email: 'regular6@test.com', role: userRole.Id },
      { id: 'user_regular_7', name: 'Usuario Regular 7', email: 'regular7@test.com', role: userRole.Id },
      { id: 'user_regular_8', name: 'Usuario Regular 8', email: 'regular8@test.com', role: userRole.Id },
      { id: 'admin_1', name: 'Administrador 1', email: 'admin1@test.com', role: adminRole.Id },
      { id: 'admin_2', name: 'Administrador 2', email: 'admin2@test.com', role: adminRole.Id },
    ];
    ...
    for (const u of usersToSeed) {
      ...
      if (created) {
        ...
        console.log(`✅ Usuario creado: ${u.name} (${u.email}) -> ID: ${user.Id}`);
      } else {
